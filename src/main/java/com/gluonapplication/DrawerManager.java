...
import com.gluonapplication.views.MenuController;
...
public class DrawerManager {
    ...
    public static void buildDrawer(AppManager app) {
        ...
        final Item tertiaryItem = new ViewItem("Api",new MenuController().getGETRequest(),API_VIEW);
        drawer.getItems().addAll(primaryItem, secondaryItem,tertiaryItem);
